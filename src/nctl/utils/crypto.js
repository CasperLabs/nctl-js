...
export const getKeyPairOfFaucet = () => {
    const pathToKeyPair = io.getPathToFaucet();

    return getKeyPair(pathToKeyPair);
}
...
export const getKeyPairOfNode = (nodeID) => {
    const pathToKeyPair = io.getPathToNodeKeys(nodeID);
...
export const getKeyPairOfUser = (userID) => {
    const pathToKeyPair = io.getPathToUser(userID);
